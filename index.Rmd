...
Row {.tabset .tabset-fade data-height=950}
-------------------------------------
...
For the following `r current_deployments_1 %>% nrow()` deployments, the `deploy_date_time` was more than `r cutoff_year_closed_deployment` years ago.
