...
# 
# BTN_lost_anim <- etn::get_animals(animal_project_code = "BTN_LOST")
# skate_det2 <- etn::get_acoustic_detections(animal_project_code = "2018_FLAPPERSKATE")
# library(dplyr)
# 
#  fs_ani <- etn::get_animals(animal_project_code = "2018_flapperskate") %>%
#    dplyr::arrange(release_date_time)
#  # get detections
# fs_det <- etn::get_acoustic_detections(animal_project_code = "2018_flapperskate")
```
...
```{r ETN logo, out.width="100%"}
knitr::include_graphics("images/etn_logo.png")
...
### Quick info {#about-quickInfo data-width=350}

Dashboard effective as of **`r Sys.Date()`**


***


This dashboard gives an overview on open acoustic deployments within these acoustic project codes: 
*`r current_deployments$acoustic_project_code %>% unique()`*

***

**What do the colors on the map mean?**

* **<span style="color: `r battery_ok_colour`;">Blue</span>**: Battery and metadata are OK

* **<span style="color: `r needs_bat_change_colour`;">Orange</span>**: Battery is estimated to end in the next `r months_to_maintenance` months

* **<span style="color: `r needs_manual_check_colour`;">Black</span>**: Deployment metadata are not ok -> more info in Tab *2. Manual check in ETN portal*



### Map {#about-map data-width=650}
